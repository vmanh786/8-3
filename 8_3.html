...
<body>
    ...
    <script>
        ...
        const textLetterH2 = "Gửi mọi người!";
        ...
        const textLetterP = "Hôm nay là ngày 08/03. Xin gửi lời chúc tới các bạn nữ lớp 10A2 và cô Hồng Trang. Chúc các bạn luôn vui vẻ, luôn hạnh phúc và luôn may mắn trong cuộc sống, ngày càng xinh đẹp. Xin gửi tất cả lời chúc tốt đẹp đến với mọi người. Love You💗";
